...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() {
		...
		for (int i= 0; i < numVertices; i++) {
			sequence[i] = getNeighbors(i).size() + getInNeighbors(i).size();
		}
...
//		THIS was my first time, when I thought I was to return the INDICES in order
//		int[] hash = new int[numVertices];
//		for (int i = 0; i < numVertices; i++) {
//			hash[i] = (getNeighbors(i).size() + getInNeighbors(i).size());
//		}
//		ArrayList<Integer> list = new ArrayList<>();
...
//		}
	...
	public static void main (String[] args) {
		...
		// Timing tests for 'brute force' vs 'matrix multiplication'
//		long millis = System.nanoTime();
//		System.out.println(graphFromFile.getDistance2(4));
//		millis = System.nanoTime() - millis;
//		System.out.println("Normal: " + millis);
//		millis = System.nanoTime();
//		System.out.println(graphFromFile.getDistance2Matrix(4));
//		millis = System.nanoTime() - millis;
//		System.out.println("Matrix Mult: " + millis);
